...
class driving_log_updater:
    ...
    def __init__(self):
        ...
        self.vehicle_adaptor_cmd_history = []
        self.accel_cmd_list = []
        self.brake_cmd_list = []
    ...
    def clear_list(self):
        ...
        self.kinematic_state_list.clear()
        self.acceleration_list.clear()
        self.steering_status_list.clear()
        self.control_cmd_orig_list.clear()
        self.operation_mode_list.clear()
        self.vehicle_adaptor_cmd_history.clear()
        self.accel_cmd_list.clear()
        self.brake_cmd_list.clear()
    ...
    def update(self, t_current, states, inputs, vehicle_adaptor_inputs, accel, brake,part=None):
        ...
        vehicle_adaptor_cmd[0] = t_sec
        vehicle_adaptor_cmd[1] = t_n_sec
        vehicle_adaptor_cmd[2] = vehicle_adaptor_inputs[0]
        vehicle_adaptor_cmd[3] = vehicle_adaptor_inputs[1]
        #self.vehicle_adaptor_cmd_list.append(vehicle_adaptor_cmd)
        ...
        self.vehicle_adaptor_cmd_history.append(vehicle_adaptor_cmd)
        accel_cmd[0] = t_sec
        accel_cmd[1] = t_n_sec
        accel_cmd[2] = accel
        self.accel_cmd_list.append(accel_cmd)
        brake_cmd[0] = t_sec
        brake_cmd[1] = t_n_sec
        brake_cmd[2] = brake
        self.brake_cmd_list.append(brake_cmd)
    ...
    def save(self, save_dir):
        ...
        np.savetxt(save_dir + "/vehicle_adaptor_cmd.csv",
            np.array(self.vehicle_adaptor_cmd_history),
            delimiter=","
        )
        np.savetxt(save_dir + "/accel_cmd.csv", np.array(self.accel_cmd_list), delimiter=",")
        np.savetxt(save_dir + "/brake_cmd.csv", np.array(self.brake_cmd_list), delimiter=",")
