...
/**
 * @brief check whether the object type is ObjectClassification::UNKNONW.
 * @param object data.
 * @return if the object label whose probability is the highest among the canciddates is UNKNONW,
 * return true.
 */
 ...
 * @param parameters.
 * @return if this funciton finds there is no enough space to avoid, return nullopt.
 */
