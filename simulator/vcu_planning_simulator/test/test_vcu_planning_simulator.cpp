...
using simulation::vcu_planning_simulator::VcuPlanningSimulator;
...
{
public:
  PubSubNode() : Node{"test_vcu_planning_simulator_pubsub"}
  {
...
class TestVcuPlanningSimulator : public ::testing::TestWithParam<std::string>
{
};

TEST_P(TestVcuPlanningSimulator, TestIdealSteerVel)
{
  ...
  const auto sim_node = std::make_shared<VcuPlanningSimulator>(node_options);
...
INSTANTIATE_TEST_SUITE_P(
  TestForEachVehicleModel, TestVcuPlanningSimulator, ::testing::ValuesIn(VEHICLE_MODEL_LIST));
