...
private:
  ...
  autoware_auto_vehicle_msgs::msg::VelocityReport::ConstSharedPtr odom_;
  ...
  void onOdometry(const autoware_auto_vehicle_msgs::msg::VelocityReport::ConstSharedPtr msg);
